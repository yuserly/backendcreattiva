...
class SubcategoriasSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Subcategorias::create(['nombre'     => 'Hosting Amazon', 'slug' => 'hosting-amazon', 'icono' => 'fab fa-amazon', 'categoria_id' => 1, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Hosting Windows', 'slug' => 'hosting-windows', 'icono' => 'fab fa-windows', 'categoria_id' => 1, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Hosting Wordpress', 'slug' => 'hosting-wordpress', 'icono' => 'fab fa-wordpress', 'categoria_id' => 1, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Hosting Reseller', 'slug' => 'hosting-reseller', 'icono' => 'fas fa-network-wired', 'categoria_id' => 1, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Tienda Online', 'slug' => 'tienda-online', 'icono' => 'fas fa-network-wired', 'categoria_id' => 1, 'preseleccionado' => 1]);
        Subcategorias::create(['nombre'     => 'Certificado SSL', 'slug' => 'certificado-ssl', 'icono' => 'fas fa-network-wired', 'categoria_id' => 1, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Instalación Certificado SSL', 'slug' => 'instalacion-certificado-ssl', 'icono' => 'fas fa-network-wired', 'categoria_id' => 1, 'preseleccionado' => 4]);
        //************



        //VPS 9
        Subcategorias::create(['nombre'     => 'Servidores VPS en Chile', 'slug' => 'servidores-vps-en-chile' ,'icono' => 'fab fa-linux', 'categoria_id' => 2, 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'Servidores VPS Windows', 'slug' => 'servidores-vps-windows', 'icono' => 'fab fa-windows', 'categoria_id' => 2 , 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'VPS Amazon Linux', 'slug' => 'vps-amazon-linux', 'icono' => 'fab fa-amazon', 'categoria_id' => 2 , 'preseleccionado' => 2]);
        Subcategorias::create(['nombre'     => 'VPS Linux Administrados', 'slug' => 'vps-linux-administrados', 'icono' => 'fab fa-linux', 'categoria_id' => 2 , 'preseleccionado' => 4]);
        Subcategorias::create(['nombre'     => 'VPS Amazon Windows', 'slug' => 'vps-amazon-windows', 'icono' => 'fab fa-windows', 'categoria_id' => 2 , 'preseleccionado' => 2]);
        ...
        Subcategorias::create(['nombre'     => 'Servidores HP', 'slug' => 'servidores-hp' ,'icono' => 'fas fa-server', 'categoria_id' => 3, 'preseleccionado' => 7]);
        Subcategorias::create(['nombre'     => 'Servidores DELL', 'slug' => 'servidores-dell', 'icono' => 'fas fa-server', 'categoria_id' => 3, 'preseleccionado' => 7]);
        ...
        //Hosting Cloud 20
        Subcategorias::create(['nombre'     => 'Google Workspace', 'slug' => 'google-workspace', 'icono' => 'fab fa-google', 'categoria_id' => 4, 'preseleccionado' => 2]);
        ...
        Subcategorias::create(['nombre'     => 'Google Ads', 'slug' => 'google-ads', 'icono' => 'fab fa-google', 'categoria_id' => 4, 'preseleccionado' => 6]);
